/**
 * CustomTransactionResponse.java
 *
...
public class CustomTransactionResponse  implements java.io.Serializable {
    private java.lang.String responseDateTime;

    private api.mws.schema.safetypay.TransactionInfoType transactionInfo;

    private java.lang.String signature;

    private api.mws.schema.safetypay.ErrorManagerType errorManager;

    public CustomTransactionResponse() {
    }

    public CustomTransactionResponse(
           java.lang.String responseDateTime,
           api.mws.schema.safetypay.TransactionInfoType transactionInfo,
    ...
    /**
     * Gets the responseDateTime value for this CustomTransactionResponse.
     * 
    ...
    /**
     * Sets the responseDateTime value for this CustomTransactionResponse.
     * 
    ...
    /**
     * Gets the transactionInfo value for this CustomTransactionResponse.
     * 
     * @return transactionInfo
     */
    public api.mws.schema.safetypay.TransactionInfoType getTransactionInfo() {
        return transactionInfo;
    }


    /**
     * Sets the transactionInfo value for this CustomTransactionResponse.
     * 
     * @param transactionInfo
     */
    public void setTransactionInfo(api.mws.schema.safetypay.TransactionInfoType transactionInfo) {
        this.transactionInfo = transactionInfo;
    }


    /**
     * Gets the signature value for this CustomTransactionResponse.
     * 
     * @return signature
     */
    ...
    /**
     * Sets the signature value for this CustomTransactionResponse.
     * 
     * @param signature
     */
    ...
    /**
     * Gets the errorManager value for this CustomTransactionResponse.
     * 
     * @return errorManager
     */
    ...
    /**
     * Sets the errorManager value for this CustomTransactionResponse.
     * 
     * @param errorManager
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomTransactionResponse)) return false;
        CustomTransactionResponse other = (CustomTransactionResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomTransactionResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:safetypay:messages:mws:api", ">CustomTransactionResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:safetypay:messages:mws:api", "TransactionInfo"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:safetypay:schema:mws:api", "TransactionInfoType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
