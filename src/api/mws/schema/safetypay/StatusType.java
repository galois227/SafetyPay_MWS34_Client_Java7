...
public class StatusType  implements java.io.Serializable {
    ...
    /**
     * Gets the description value for this StatusType.
     * 
     * @return description
     */
    ...
    /**
     * Sets the description value for this StatusType.
     * 
     * @param description
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:safetypay:schema:mws:api", "StatusType"));
